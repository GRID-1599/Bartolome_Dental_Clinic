...
<body>
    ...
    <div class="container-xxl mt-5 mb-5  px-4">
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-md-4">
                <div id="carouselExampleIndicators" class="carousel slide rounded-pill" data-bs-ride="carousel"
                style="max-height: 100%">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="resources/images/120820190_2215124955298241_3255555329355204296_n.jpg" class="d-block w-100" alt="..." >
                        </div>
                        <div class="carousel-item">
                            <img src="resources/images/120589084_2215125081964895_2536350470340704381_n.jpg" class="d-block w-100" alt="..." >
                        </div>
                        <div class="carousel-item">
                            <img src="resources/images/120423691_2215125041964899_2238336428774706707_n.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="resources/images/120770599_2215124871964916_6534420109982184615_n.jpg" class="d-block w-100" alt="...">
                        </div>
                    </div>
            ...
            <div class="col-md-4 mb-3  d-flex  justify-content-center ">
                <div class="dentistInfo__image ">
                    ...
                    <div class="img2 position-relative ">
                        <img src="resources/images/hannaah.png" alt="Dr. Mirzi Leigh Hannah DC. Bartolome" class="position-absolute top-50 start-50 translate-middle">
                    </div>
                </div>
            </div>
    ...
    <div class="container-xxl mt-5  px-4">
        <p class="text-header text-center">Where to find Us</p>
    ...
    <div class="container-xxl mt-5  px-4">
        <div class="row justify-content-center px-3">
            ...
            <div class="col-sm-3">
                <i class="fa fa-envelope fa-5x icon-pink" aria-hidden="true"></i>
                <h3>Email Us</h3>
                <p>thepinkdmd@gmail.com</p>
            </div>
            <div class="col-sm-3">
                <i class="fa fa-facebook-official fa-5x icon-pink" aria-hidden="true"></i>
