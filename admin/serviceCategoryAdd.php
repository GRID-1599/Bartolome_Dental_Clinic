...
$lastServiceCat_Id = substr($serviceCategory_obj->getLastServiceCategoryID(), 1);
$newServiceCat_Id = "S" . ($lastServiceCat_Id + 1) ;
...
<body class="sb-nav-fixed">
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">New Service Category</li>
                    </ol>

                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-tooth me-1"></i> New Service Category
                        </div>
                        <div class="card-body">

                            <div class="container">
                                <dl class="row">
                                    <dt class="col-sm-3">Service Category ID</dt>
                                    <dd class="col-sm-9">
                                        <p id="service_id"><?php echo $newServiceCat_Id ?></p>
                                    </dd>
                                    ...
                                    <dd class="col-sm-9">
                                        ...
                                        <img src="../resources/Dental_Pics/ALL_CATEGORIES/logov2.png" alt="Default Service Image" class="img-thumbnail" id="serviceImage">
    ...
    <script src="js/serviceCategoryAdd.js"></script>
</body>
